...
def generate_integral():
    from sympy import Symbol, sin, cos, exp, sqrt, log, pi, integrate, Rational, simplify
...
def main():
    ...
    display, answer = generate_integral()
    ...
    while True:
        ...
        if check_answer(user_input, answer):
            ...
            print(f"  Solved in {attempt} attempt(s). Well done!")
            print()
            break
        else:
            print("  WRONG! The alarm continues... Try again!")
